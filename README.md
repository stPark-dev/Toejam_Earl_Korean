...
| 크레딧 | 한글(사람 이름은 원문) |
| 하단 HUD(등급, 휴가 중), 선물 목록 이름 | 한글(8x8 폰트) |
| "BUCKS", "POINTS", "OPEN", "SHIP PIECE HERE" 등 그림 문자 | 미착수 |
| 타이틀 로고 | 미착수 |

하단 HUD는 8픽셀 3줄짜리 패널이어서 16픽셀 한글이 들어가지 않습니다. 이 영역은 Galmuri7 기반 8x8 한글 폰트를
따로 만들어 한 줄로 출력합니다. 글자가 작으므로 등급 이름과 선물 이름은 짧게 옮겼습니다.
...
- 한글은 16x16(Galmuri14), 영문은 8x16(Galmuri11), HUD 한글은 8x8(Galmuri7) 글리프입니다.
